...
export class TableComponent implements OnInit {
  @Input() list: RolesInstitucionales[] = [];
  @Output() selectedOneRegister = new EventEmitter<RolesInstitucionales>();
  ...
  edit(register: RolesInstitucionales): void {
