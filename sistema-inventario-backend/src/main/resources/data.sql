...
/**/
INSERT INTO entidad_publica (honorario_senescyt, familiar_senescyt, nombre_familiar, observaciones, codigo_instituto)
VALUES (1, 1, 'Johan', 'nuevo empleado', 15),
(2, 0, 'Maria', 'empleado transferido', 20);
...
/**/
INSERT INTO escala_ocupacional (nivel_jerarquicosuperiror2, servidor_publico4) VALUES
('rector', 'docente');

/**/
INSERT INTO titulos (titulos_optenidos ,institucion, año_de_titulo, intruccion_formal,numero_De_registrosenesyt) 
...
/**/
INSERT INTO estudios_en_curso ( nombre, tipo_de_titulo. fecha_de_inicio, fecha_de_fin, numero_de_horas) VALUES
('masterado en mecanica', 'phd', 2024-06-05, 2025-09-07, 523);

/**/
INSERT INTO categorias_bien ( nombre ) VALUES ('CPU');

/**/
INSERT INTO bienes (codigo_del_bien, custodio, descripcion, estado, marca, modelo, nombre, observaciones, serie, valor, valor_iva, id_categoria_bien)
VALUES
  ('wwwputow7w7gf', 1, 'nueva', true, 'hp', 'm7x', 'laptop', 'sin observaciones', '12345abc', 15.1, 11, 1),
  ('abcde12345', 2, 'antiguo', false, 'dell', 'xps13', 'ordenador', 'requiere mantenimiento', '67890def', 20.5, 16, 2),
  ('fghij67890', 3, 'nuevo', true, 'acer', 'swift3', 'laptop', 'sin detalles', '54321ghi', 25.0, 21, 3);
...
'1990-05-15', '08:00-17:00', 'Matemáticas, Física', 'Presencial', 
...
'1985-10-20', '07:00-16:00', 'Historia, Literatura', 'Semipresencial', 
'Medio tiempo', 'María', 1200.75, '0998765432', '033456789', 'A-', 
1, 2, 1, 2, 1, 2, 1, 2, 3, 1, 2, 1),
('Martínez', 'martinez@example.com', 'Av. Libertad 456', '3456789012', 'Negro', 
'1988-03-12', '08:30-17:30', 'Ciencias Sociales, Economía', 'Presencial', 
'Tiempo completo', 'Pedro', 1600.00, '0912345678', '055678901', 'AB+', 
