package com.example.sistema.inventario.backend.authz.controller;
...
import com.example.sistema.inventario.backend.authz.conf.JWTUtil;
...
import com.example.sistema.inventario.backend.authz.service.AuthorityService;
